...
class SkillManager:
    ...
    def generate_skill_description(self, program_name, program_code):
        messages = [
            SystemMessage(content=load_prompt("skill"+("" if self.use_pre_planning_prompt else "_no_pre_planning"))),
            HumanMessage(
        ...
        skill_description = f"    // { self.llm_invoker(self.llm,(messages)).content}"
